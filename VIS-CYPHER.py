...
if __name__ == "__main__":
    ...
    plaintext_bytes = b"This is secret binary data to be encrypted with VIS-Cipher Advanced. We are testing byte plaintext." #(or "plaintext_string.encode('utf-8')" for it to be the same as the string)
